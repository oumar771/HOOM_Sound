...
///
/// Ce service fournit des méthodes pour la connexion, l'inscription, la déconnexion,
...
class AuthService {
  ...
  ///
  /// Utilise la méthode [signInWithPassword]. Si une erreur survient,
  ...
  Future<Session> signIn({
    ...
    try {
      ...
      if (response.session == null) {
        throw Exception("Aucune session créée. Vérifiez vos informations de connexion.");
      }
  ...
  ///
  /// Utilise la méthode [signUp]. Si l'inscription réussit mais qu'aucune session n'est créée,
  ...
  Future<void> resetPassword({
    ...
    try {
      ...
      throw Exception("Une exception est survenue lors de la réinitialisation du mot de passe : $e");
    }
  }
  ...
  Future<void> updatePassword({
    ...
    try {
      ...
      throw Exception("Une exception est survenue lors de la mise à jour du mot de passe : $e");
    }
  }
}
